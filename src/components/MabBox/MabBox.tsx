	...
	return (
		...
		>
			<Marker longitude={-118.15937045855739} latitude={33.919123017099594}>
				...
				<span
					id="mapBox-marker"
					className="h-5 w-5 flex items-center justify-center rotate-45 cursor-pointer"
				>
					<span className="absolute h-5 w-5 animate-ping bg-cyan-500 dark:bg-orange-500 opacity-75" />
					<span className="h-4 w-4 bg-cyan-600 dark:bg-orange-600 opacity-90" />
				</span>
			</Marker>
		</Map>
	)
